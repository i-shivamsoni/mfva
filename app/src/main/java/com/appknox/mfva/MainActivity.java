    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSharedPref.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String[] keys = new String[]{"java.class.version", "java.home", "java.library.path", "java.vendor", "java.vendor.url", "java.specification.name", "java.vm.name", "java.vm.version", "java.vm.specification.name", "java.vm.specification.version", "os.arch", "os.name", "os.version",};
        ...
        buttonDebugLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String[] quotes = new String[]{"Any given program, when running correctly, is obsolete.", "Disco is to music what Etch-A-Sketch is to art.", "Computer Science is merely the post-Turing decline in formal systems theory.", "Sometimes the only solution is to find a new problem.", "There are 10 kinds of people. Those who know binary and those who don't.", "Whom computers would destroy, they must first drive mad.", "I program, therefore I am.", "If Java had true garbage collection, most programs would delete themselves upon execution.", "Hardware, n.: The parts of a computer system that can be kicked.", "There are two ways to write error-free programs. Only the third one works.", "Why isn't \"palindrome\" spelled the same way backwards?", "A language that doesn't affect the way you think about programming is not worth knowing.", "All programmers are playwrights and all computers are lousy actors.", "Every program has two purposes ― one for which it was written and another for which it wasn't.", "Every program is a part of some other program, and rarely fits.",};
